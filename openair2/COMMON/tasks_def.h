...
//Dual Connectivity Tasks
TASK_DEF(TASK_X2U,      TASK_PRIORITY_MED,          200)
TASK_DEF(TASK_UE_DC,      TASK_PRIORITY_MED,          200)
TASK_DEF(TASK_UDP_UE,      TASK_PRIORITY_MED,          1000)
TASK_DEF(TASK_PDCP_REORDERING,      TASK_PRIORITY_MED,          200)
